...
import { registerSaga, loginSaga, updateUserPassword, recoverPassword } from './authSagas';
...
function* rootSaga() {
  ...
  yield  takeLatest(ACTION.UPDATE_PASSWORD, updateUserPassword);
  yield takeLatest(ACTION.RECOVER_PASSWORD_ACTION, recoverPassword)
}
